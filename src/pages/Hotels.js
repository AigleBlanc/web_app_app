                    ...
                    <div class="tm-banner-inner">
                        <div class="tm-banner-inner">
                            <h1 class="tm-banner-title"><span class="tm-yellow-text">50 Partner Hotels </span> in India</h1>
                                <p class="tm-banner-subtitle">Our Offer Prices are 70% of the Regular Price at Any of The Hotels. <br/> Book With Us, Save on Your Trips.</p>
                            <a href="#more" class="tm-banner-link">Filter By</a>	
                        </div>	
                    </div> 
                </section>
